...
{
	FWriteToRenderTargetInterface::SetInvertColors(bIsChecked);
}

void UShaderModWidget::OnGrayscaleChanged(bool bIsChecked)
{
	FWriteToRenderTargetInterface::SetGreyscale(bIsChecked);
}

void UShaderModWidget::OnContrastChanged(float Value)
{
	FWriteToRenderTargetInterface::SetContrast(Value);
}

void UShaderModWidget::OnDistortionChanged(float Value)
{
	FWriteToRenderTargetInterface::SetDistortionStrength(Value);
}

void UShaderModWidget::OnScalingChanged(float Value)
{
	FWriteToRenderTargetInterface::SetImageScale(Value);
}

void UShaderModWidget::OnRotationChanged(float Value)
{
	FWriteToRenderTargetInterface::SetRotationAngle(Value);
}
